...
class RouteDistanceCalculatorTest {
    ...
    void testCalculateTotalRouteDistanceWithTenAddresses() {
        ...
        addresses.add(createAddress(1L, 52.379189, 4.899431));
        addresses.add(createAddress(2L, 51.9225, 4.47917));
        addresses.add(createAddress(3L, 52.0705, 4.3007));
        addresses.add(createAddress(4L, 52.0907, 5.1214));
        addresses.add(createAddress(5L, 51.4416, 5.4697));
        addresses.add(createAddress(6L, 53.2194, 6.5665));
        addresses.add(createAddress(7L, 52.5200, 5.7480));
        addresses.add(createAddress(8L, 51.5866, 4.7750));
        addresses.add(createAddress(9L, 52.5050, 6.0900));
        addresses.add(createAddress(10L, 51.8126, 5.8372));
    ...
    private Address createAddress(Long id, double lat, double lng) {
